...
public class MysqlGenerator2 {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir("G:/develop/code4/");
		...
		dsc.setUsername("root");
		dsc.setPassword("root");
		dsc.setUrl("jdbc:mysql://localhost:3306/vacomall?characterEncoding=utf8");
		...
		strategy.setTablePrefix(new String[] { "ecs_"});// 此处可以修改为您的表前缀
		strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
		 strategy.setInclude(new String[] { "ecs_brand" }); // 需要生成的表
		...
		pc.setParent("com.vacomall");// 自定义包路径
